 ...
 * 发送语音消息的按钮button类
 */
public class HiVoiceRecorderButton2 extends FloatingActionButton implements HiMediaRecordManager.AudioStateListener {
    ...
    public HiVoiceRecorderButton2(Context context) {
        this(context, null);
    }

    public HiVoiceRecorderButton2(Context context, AttributeSet attrs) {
        super(context, attrs);
...
//                isRecording = true;
    ...
    private void setText(int textId){
        ToastUtils.showToast(mContext, getResources().getString(textId), Toast.LENGTH_SHORT);
    }
